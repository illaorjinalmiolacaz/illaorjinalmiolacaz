 ...
 * Updates will be posted to this site.a
 ******************************************************/
var ibacor_ycp = function(m, n, o, p) {
    ...
    function youtube_video_list(f, g, h, j, k, l) {
        $.ajax({
            ...
            var d = '';
            d += '<div class="ibacordotcom-vid-top"><span class="ibacordotcom-nav-title">' + j + '</span><br><span class="ibacordotcom-vid-by">Gönderen: <a href="http://www.youtube.com/user/' + l + '" target="_BLANK">' + l + '</a></span><hr>';
            d += '<i class="fa fa-fast-backward ibacordotcom_vid_prev" title="Önceki Video"></i> ';
            d += '<i class="fa fa-fast-forward ibacordotcom_vid_next" title="Sonraki Video"></i></div><div class="ibacordotcom-vid-bottom">';
    ...
    function _timeSince(a) {
        ...
        return Math.floor(s) + " saniye önce"
    }
